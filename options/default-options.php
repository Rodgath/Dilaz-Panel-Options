	...
	// );
		...
		$options[] = array(
			...
			'options' => array(
				...
				'text4' => array('name' => __('Text 4', 'dilaz-panel'), 'default' => 'Sample Four'),
				'text5' => array('name' => __('Text 5', 'dilaz-panel'), 'default' => 'Sample Five'),
				'text6' => array('name' => __('Text 6', 'dilaz-panel'), 'default' => 'Sample Six'),
			),
